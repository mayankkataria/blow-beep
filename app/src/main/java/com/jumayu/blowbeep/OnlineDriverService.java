...
public class OnlineDriverService extends Service {
    ...
    LocationCallback myLocationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            DatabaseReference passLoc = FirebaseDatabase.getInstance().getReference().child("Drivers Online").child(userId).child("location");
            location = locationResult.getLastLocation();
            driverInfo.setLocation(location);
            if (location != null) {
    ...
    private static final String TAG = "OnlineDriverService";
